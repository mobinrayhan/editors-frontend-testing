  ...
  return (
    <Fragment>
      <div>
        ...
        <div>
          <span>
            <span className="me-1 text-dark fw-semibold">
              4.4 <Icon path={mdiStar} size={0.6} className="text-success" />
            </span>
                ...
                <Fragment key={index}>
                  ...
                  <Form.Check.Label
                    className={
                      "btn btn-" +
                      item +
                      " rounded-circle me-2 btn-icon btn-xs border border-2 border-white shadow "
                    }
          ...
          <ButtonGroup aria-label="Basic example">
            {[6, 7, 8, 9, 10, 11].map((item, index) => (
              <Fragment key={index}>
                ...
                />
                <Form.Check.Label
                  className="btn btn-outline-light border rounded-circle me-2 text-body btn-icon btn-md"
        ...
        <Col md={6}>
          <div className="d-grid">
            <Link href="#" className="btn btn-outline-secondary">
              <i className="fe fe-heart me-2"></i>Wishlist
            </Link>
          </div>
        </Col>
      </Row>
