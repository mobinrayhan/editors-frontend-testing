    ...
    <Fragment>
      <div className="mb-4">
        ...
        <p>
          ...
          examples. Lastly, you&apos;ll put your JavaScript knowledge to work
          and modify a modern, responsive web page. When you&apos;re finished
          with this course, you&apos;ll have the skills and knowledge in
          JavaScript to create simple programs, create simple web applications,
