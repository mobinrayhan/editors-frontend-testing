        ...
        <Row>
          <Col xl={12} lg={12} md={12} sm={12}>
            <div className="mb-4">
              ...
              <p>
                Bootstrap scopes the <code>:valid</code> and{" "}
                <code>:invalid</code> styles to parent{" "}
                <code>.was-validated</code> className, usually applied to the{" "}
                <code>&lt;Form&gt;</code> (you can use the{" "}
          ...
          <Col xl={12} lg={12} md={12} sm={12} className="mt-4">
            <div className="mb-4">
              ...
              <p>
                ...
                <code>position: relative</code> on it for tooltip positioning.
                In the example below, our column classes have this already, but
                your project may require an alternative setup.
              </p>
            </div>
            <Tab.Container defaultActiveKey="design">
              <Card>
