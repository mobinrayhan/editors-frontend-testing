        ...
        <Row>
          <Col md={12} xs={12}>
            <div className="mb-8">
              ...
              <p className="mb-0">
                Below are the core tools which we use for building a Geeks UI
                Next.js theme. For more detail of the toolset, go to their
                official websites.
              </p>
            </div>
            <div className="mb-8">
                    ...
                    <Card.Body>
                      <div className="mb-6">
                        ...
                        <p>
                          ...
                          is a React framework for building full-stack web
                    ...
                    <Card.Body>
                      <div className="mb-6">
                        ...
                        <p>
                          ...
                          replaces the Bootstrap JavaScript. Each component has
                          been built from scratch as a true React component,
