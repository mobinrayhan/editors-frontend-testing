          ...
          <Col md={12} xs={12}>
            <div className="mb-8">
              ...
              <p>
                ...
                and files. The application is created using{" "}
                <code>npx create-next-app@latest</code> by seleting following
                options at the time of setup.
              </p>
              <pre>
                What is your project named? <b>geeks-nextjs-app-router</b>
                <br />
                Would you like to use TypeScript? <b>No</b>
                <br />
                Would you like to use ESLint? <b>Yes</b>
                <br />
                Would you like to use Tailwind CSS? <b>No</b>
                <br />
                Would you like to use `src/` directory? <b>No</b>
                <br />
                Would you like to use App Router? (recommended) <b>Yes</b>
                <br />
              ...
              <p>
                Once installed, we have updated <code> jsconfig.json </code>{" "}
                file as shown below. For more options visit{" "}
                <Link
                  href="https://code.visualstudio.com/docs/languages/jsconfig"
                  target="_blank"
                >
                  VS Code Studio <i className="fe fe-external-link"></i>
                </Link>
              </p>
              <HighlightCode code={JSConfig} />
              <p>
                For more detailed Next.js application directories and files
                structure, visit{" "}
                <Link
            ...
            <div>
              <h4 className="mb-3">
                Here is how the Geeks Next.js ( app router ) theme organizes its
                file structure:
              </h4>
