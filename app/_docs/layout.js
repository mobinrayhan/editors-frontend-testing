...
export default function DashboardLayout({ children }) {
	...
	return (
		<div className="docs-main-wrapper">
				...
				<nav className="navbar navbar-expand-md fixed-top ms-0">
					...
					<div className="ms-auto d-flex align-items-center">
						...
						<div className="d-flex">
							...
							<div>
								<Button bsPrefix='btn-icon' className="btn navbar-toggler" onClick={() => setShowMenu(!showMenu)} type="button" >
			...
			{hasMounted && <DocSidebar showMenu={showMenu} onClick={() => setShowMenu(false)} />}
