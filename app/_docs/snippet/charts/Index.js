...
import {
  DataWithBarChart,
  DataWithBarChartCode,
} from "./components/DataWithBarChart";
import {
  DataWithLineChart,
  DataWithLineChartCode,
} from "./components/DataWithLineChart";
              ...
              tabs={[
                {
                  ...
                  tabKey: "design",
                  tabTitle: "Design",
                  tabData: item.tabContent,
                },
                {
                  id: 2,
                  tabKey: "code",
                  tabTitle: "Code",
                  tabData: <HighlightCode code={item.codeContent} />,
                },
              ]}
            />
          </Col>
