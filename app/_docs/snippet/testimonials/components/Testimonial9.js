    ...
    <section className="bg-dark-primary py-lg-8 py-6">
      <Container className="py-lg-6">
        <Row>
          <Col xxl={{ span: 6, offset: 3 }} lg={{ span: 8, offset: 2 }} xs={12}>
            <div className="text-center mb-6 d-flex flex-column gap-2">
              <h2 className="mb-0 text-white h1">
              ...
              <p className="mb-0 text-white">
                ...
                they’ve left an rating of 4.9 out of 5 for our mentors.
              </p>
            </div>
          </Col>
        </Row>
        <Row className="gy-4">
          ...
          {Array.from(
            { length: Math.ceil(TestimonialsData.length / 2) },
            (_, i) => TestimonialsData.slice(i * 2, i * 2 + 2)
              ...
              >
                {chunk.map((testimonial, index) => (
                  <Link
                    ...
                    scroll={false}
                    onClick={() => {
                      setActiveTestimonial(testimonial.id), setModalShow(true);
                    }}
                  >
