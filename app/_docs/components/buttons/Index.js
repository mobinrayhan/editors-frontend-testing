        ...
        <Row>
          <Col xl={12} lg={12} md={12} sm={12} className="mt-5">
            <p className="mb-3">
              ...
              <code>.d-md-block</code> replaces the <code>.d-grid</code>{" "}
              className, thus nullifying the <code>gap-2</code> utility. Resize
              your browser to see that change.
            </p>
            <Tab.Container defaultActiveKey="design">
              <Card>
                <Card.Header className="border-bottom-0 p-0 ">
        ...
        <Row>
          <Col xl={12} lg={12} md={12} sm={12} className="mt-5">
            <p className="mb-3">
              ...
              buttons when horizontal. Here we’ve taken our previous responsive
