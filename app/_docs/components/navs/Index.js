          ...
          <Col xl={12} lg={12} md={12} sm={12} className="mt-4">
            <div className="mb-4">
              <p>
                ...
                <code>&lt;Nav.Link&gt;</code> directly, which would create
                invalid markup by default (ul &lt; a).
              </p>
            </div>
            <Tab.Container defaultActiveKey="design">
              <Card>
            ...
            <div className="mb-4">
              ...
              <div className="mt-4">
                ...
                <p>
                  ...
                  utility classes. By default, navs are left-aligned, but that
                  is easily changed to center or right-aligned.
                </p>
                <p>
          ...
          <Col xl={12} lg={12} md={12} sm={12}>
            <div className="mb-4">
              ...
              <p>
                ...
                <code>.flex-column</code> className, or your own css. You can
                even use the responsive versions to stack in some viewports but
                not others ( e.g. <code>.flex-sm-column</code> ).
              </p>
            </div>
            <Tab.Container defaultActiveKey="design">
              <Card>
          ...
          <Col xl={12} lg={12} md={12} sm={12}>
            <div className="mb-4">
              ...
              <p>
                ...
                of flexbox utilities. While more verbose, these utilities offer
                    ...
                    <Tab.Pane eventKey="design" className="pb-4 p-4">
                      ...
                      >
                        <Tab eventKey="home" title="Home">
                          ...
                          nisi incididunt nostrud exercitation proident est
                          nisi. Irure magna elit commodo anim ex veniam culpa
                          eiusmod id nostrud sit cupidatat in veniam ad. Eiusmod
                          consequat eu adipisicing minim anim aliquip cupidatat
                          culpa excepteur quis. Occaecat sit eu exercitation
                        ...
                        <Tab eventKey="profile" title="Profile">
                          ...
                          incididunt est duis anim sunt officia. Fugiat velit
                          proident aliquip nisi incididunt nostrud exercitation
                          proident est nisi. Irure magna elit commodo anim ex
                          veniam culpa eiusmod id nostrud sit cupidatat in
                          veniam ad. Eiusmod consequat eu adipisicing minim anim
                          aliquip cupidatat culpa excepteur quis. Occaecat sit
                          ...
                          <Col sm={9}>
                            <Tab.Content>
                              <Tab.Pane eventKey="home">
                                ...
                                excepteur quis. Occaecat sit eu exercitation
                                irure Lorem incididunt nostrud.
                              </Tab.Pane>
                              <Tab.Pane eventKey="profile">
                                <strong>Profile Tab</strong> - Consequat
                                occaecat ullamco amet non eiusmod nostrud dolore
                                irure incididunt est duis anim sunt officia.
                                Fugiat velit proident aliquip nisi incididunt
                                nostrud exercitation proident est nisi. Irure
                                magna elit commodo anim ex veniam culpa eiusmod
                                id nostrud sit cupidatat in veniam ad. Eiusmod
                                consequat eu adipisicing minim anim aliquip
                                cupidatat culpa excepteur quis. Occaecat sit eu
                                exercitation irure Lorem incididunt nostrud.
                              </Tab.Pane>
                              <Tab.Pane eventKey="messages">
                                <strong>Messages Tab</strong> - Consequat
                                occaecat ullamco amet non eiusmod nostrud dolore
                                irure incididunt est duis anim sunt officia.
                                Fugiat velit proident aliquip nisi incididunt
                                nostrud exercitation proident est nisi. Irure
                              ...
                              <Tab.Pane eventKey="settings">
                                <strong>Settings Tab</strong> - Consequat
                                occaecat ullamco amet non eiusmod nostrud dolore
                                irure incididunt est duis anim sunt officia.
                                Fugiat velit proident aliquip nisi incididunt
                                nostrud exercitation proident est nisi. Irure
