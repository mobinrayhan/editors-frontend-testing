          ...
          <Col xl={12} lg={12} md={12} sm={12}>
            <div className="mb-4">
              ...
              <p>
                ...
                <code>Breadcrumb.Item</code> . Do not set both{" "}
                <code>active</code> and <code>href</code> attributes.{" "}
                <code>active</code> overrides <code>href</code> and{" "}
                <code>span</code> element is rendered instead of <code>a</code>.
              </p>
            </div>
            ...
            <div className="mb-4">
              ...
              <p>
                ...
                <Link
                  ...
                  target="_blank"
                >
                  ::before <i className="fe fe-external-link"></i>
                </Link>{" "}
                and content . They can be changed by modifying a local CSS
                custom property. We have created a new style named{" "}
                <code>.slash-breadcrumb</code> className to impliment the same.
              </p>
            </div>
            <Tab.Container defaultActiveKey="all">
              <Card>
