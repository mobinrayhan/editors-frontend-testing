          ...
          <Col xl={12} lg={12} md={12} sm={12}>
            <div className="mb-4">
              ...
              <p>
                ...
                an optional body className for some initial padding.
              </p>
            </div>
        ...
        <Row>
          <Col xl={12} lg={12} md={12} sm={12}>
            <div className="mb-4">
              <h3>Responsive </h3>
              <p>
                Responsive offcanvas classes hide content outside the viewport
                from a specified breakpoint and down. Above that breakpoint, the
                contents within will behave as usual.
              </p>
            </div>
            <Tab.Container defaultActiveKey="all">
              <Card>
