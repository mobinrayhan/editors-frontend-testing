...
import { GKAccordionDefault, Ratings, CourseCard, GKTippy, InstructorProfileSummaryCard } from 'widgets';
							...
							<div>
								...
								<div className="d-flex align-items-center">
									...
									<span className="text-white ms-4 d-none d-md-block">
										<svg fill="none" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><rect fill="#DBD8E9" height="6" rx="1" width="2" x="3" y="8"></rect><rect fill="#DBD8E9" height="9" rx="1" width="2" x="7" y="5"></rect><rect fill="#DBD8E9" height="12" rx="1" width="2" x="11" y="2"></rect></svg>
