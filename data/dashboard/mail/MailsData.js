...
const description = `<div className="mt-6">
...
<p>Ullamco deserunt commodo esse deserunt deserunt quis
  ...
  ipsum
  incididunt non. <span className="text-dark">Anim aute ipsum
...
<p>The generated Lorem Ipsum is therefore always free from
  ...
  elementum. </p>
<p className="mb-0">Proin elementum, sem in ornare sodales,
...
<div className="mt-6">
  ...
  <p className="text-dark font-weight-bold mb-0">Leslie
    Alexander</p>                      </div>
</div>`;
const MailsData = [
  {
