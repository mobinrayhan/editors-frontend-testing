...
const PositionListData = [
	{
		id: uuid(),
		department: 'Design',
		description: 'Put your creative ideas into action at a product-driven and design-led organization.',
		jobtitles: [
			{
				id: uuid(),
	...
	},
	{
		...
		description: 'Develop quality code that is built for scale for millions of people looking to eliminate “work about work” with our platform.',
		jobtitles: [
			{
				id: uuid(),
