              ...
              <div>
                <Form>
                  <Form.Check
                    ...
                    onChange={() =>
                      setLatestNewsState((LatestNewsState) => !LatestNewsState)
                    }
                  />
                </Form>
              </div>
          ...
          <ListGroup variant="flush">
            ...
            <ListGroup.Item className="d-flex align-items-center justify-content-between px-0 py-2">
              <div>
                ...
                <span className="text-body">
                  Public Discussions outside of a className that teachers share
            ...
            <ListGroup.Item className="d-flex align-items-center justify-content-between px-0 py-2">
              <div>
                ...
                <p className="mb-0 text-body">
                  Announcing promos and upcoming events,such as Ask Me Anything
