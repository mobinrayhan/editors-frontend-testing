    ...
    <Card className="mb-4 mb-xl-0 card-hover border">
      ...
      <Card.Body>
        <h3 className="mb-4 text-truncate">
          <Link href={item.link} scroll={false} className="text-inherit ">{item.title}</Link>
        </h3>
        <div className="mb-4">
        ...
        <Link href={item.link} scroll={false} className="btn btn-light-primary text-primary">Register Now</Link>
      </Card.Body>
    </Card>
  )
}
